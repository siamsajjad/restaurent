...
<body>
   <div class="container">
    <header>
               <img   class="hello"  src="image/logo.png"  alt=""> 
            </div>
    ...
    <MAIN action="registration.php" method="post">
        <br><br>
      <!--banner-section starts--> 
        <section id="banner-section">
           <div class="banner-contents">
            <h1> BROTHERS OF UITS KITCHEN TABLE</h1>
            <P>10% DISCOUNT FOR UITS STUDENT</P>
            <button type="submit" value="submit" class="btn" id="submit" name="submit" ><a href="order.php" >ORDER NOW</a></button>
