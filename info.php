      ...
      <div class="feel">
                <div class="jani">
                    <div class="card">
                        <div class="card-body">
                            <div class="item-desc">
                            <h3 class="item-name">Mr. Al-Imtiaz </h3>
                            <p>PROJECT SUPERVISOR</p>
                        </div>
                            <img src="" alt="PICTURE NO. 01">
                    ...
                    <div class="card">
                        <div class="card-body">
                        <div class="item-desc">
                            <h3 class="item-name">Susmita Paul</h3>
                            <p>PROJECT MANTOR</p>
                        </div>
                            <img src="" alt="PICTURE NO. 02">
                    ...
                    <div class="card">
                        <div class="card-body">
                        <div class="item-desc">
                            <h3 class="item-name">MD. AYAN</h3>
                            <p>SENIOR DEVELOPER & MD </p>
                        </div>
                            <img src="" alt="PICTURE NO. 03">
