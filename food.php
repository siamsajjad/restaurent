        ...
        <section id="menu-section">
             <div class="row">
                <div class="jani">
                    <div class="card">
                        <div class="card-body">
                            <img src="image/lidye-1Shk_PkNkNw-unsplash.jpg" alt="">
                ...
                <div class="jani">
                    <div class="card">
                        <div class="card-body">
                            <img src="image/chad-montano-MqT0asuoIcU-unsplash.jpg" alt="">
                    
                        <div class="item-desc">
                            <h3 class="item-name">ITALIAN PIZZA </h3>
                            <p>Item No: 2</p>
                            <p>Rating: 9/10</p>
                            <p>Price : 1100</p>
                        </div>
                ...
                <div class="jani">
                    <div class="card">
                        <div class="card-body">
                            <img src="image/victoria-shes-UC0HZdUitWY-unsplash.jpg" alt="">
                    
                        <div class="item-desc">
                            <h3 class="item-name">ARABIAN KHABSHA </h3>
                            <p>Item No: 3</p>
                            <p>Rating: 9.5/10</p>
                            <p>Price : 1500</p>
                        </div>
                ...
                <div class="jani">
                    <div class="card">
                        <div class="card-body">
                            <img src="image/anna-tukhfatullina-food-photographer-stylist-Mzy-OjtCI70-unsplash.jpg" alt="">
                    
                        <div class="item-desc">
                            <h3 class="item-name">SWEET PASTRY </h3>
                            <p>Item No: 4</p>
                            <p>Rating: 9/10</p>
                            <p>Price : 190</p>
                        </div>
                ...
                <div class="jani">
                    <div class="card">
                        <div class="card-body">
                            <img src="image/BN.jpg" alt="">
                    
                        <div class="item-desc">
                            <h3 class="item-name">HAYDRABADI BIRIYANI </h3>
                            <p>Item No: 5</p>
                            <p>Rating: 9/10</p>
                            <p>Price : 200</p>
                        </div>
                ...
                <div class="jani">
                    <div class="card">
                        ...
                        <div class="item-desc">
                            <h3 class="item-name">LAVA ICE CREAM </h3>
                            <p>Item No: 6</p>
                            <p>Rating: 9/10</p>
                            <p>Price : 190</p>
                        </div>
